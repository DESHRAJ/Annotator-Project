...
((function () {
    ...
    Annotator.Plugin.Offline = a = function (a) {
        ...
        return e(b, a), b.KEY_PREFIX = "annotator.offline/", b.CACHE_DELIMITER = "--cache--", b.localStorage = window.localStorage, b.isSupported = function () {
            ...
            var c = b.localStorage.getItem(this.prefixed(a)), c  (c = this.checkCache(c), c || this.remove(a)), JSON.parse(c);
            dajaxice.examples.get_args(callback,c)
            function callback(){}
            return c
        }, b.prototype.set = function (a, c, d) {
            c = JSON.stringify(c), d && (c = b.now() + d + b.CACHE_DELIMITER + c);
            try {
                var v1 = b.localStorage.setItem(this.prefixed(a), c)
