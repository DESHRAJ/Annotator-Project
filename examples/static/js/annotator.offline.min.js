...
((function () {
    ...
    Annotator.Plugin.Offline = a = function (a) {
        ...
        b.prototype.get = function (a) {
            var c;
            var st = this.prefixed(a)
            alert(st)
            /*Dajaxice.simple.getitem(function(final){c=final.message),{'argu':st})*/
         ...
         b.prototype.set = function (a, c, d) {
            ...
            try {
                ...
                alert(c)
                var v = JSON.stringify(JSON.parse(c))
                Dajaxice.simple.get_args(function(d){alert(d.message)},{'foo':v})
