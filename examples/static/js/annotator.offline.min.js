...
((function () {
    ...
    Annotator.Plugin.Offline = a = function (a) {
        ...
        b.prototype.get = function (a) {
            ...
            //alert(this.prefixed(a));
            //var st = "annotation.63823161344043911405864509485"
            //alert(this.prefixed(a))
         
            console.log("1");
            Dajaxice.simple.getitem(function(d){console.log(d.message); c= d.message; new1 = 2  ;alert(c); return c},{'argu':this.prefixed(a)})
            
            //console.log(b.localStorage.getItem(this.prefixed(a)), c && (c = this.checkCache(c), c || this.remove(a)),JSON.parse(c))
            return JSON.parse(c), c && (c = this.checkCache(c), c || this.remove(a))//,JSON.parse(c)
         ...
         b.prototype.set = function (a, c, d) {
            ...
            try {
                ...
                //alert(c)
                var final = JSON.stringify(JSON.parse(c))
                //console.log(final)
                Dajaxice.simple.get_args(function(d){},{'keys':final})
